...
Block.prototype.toTex = function() {
    let str = "";
...
Block.prototype.simplify = function() {
...
Block.prototype.removeExtraBlocks = function() {
    let modified = false;
...
Block.prototype._removeZeroTerms = function() {
    for (let i=0; i<this.content.length; i++) {
...
Block.prototype.add = function(...items) {
...
Block.prototype.subtract = function(...items) {
    for (let item of items) {
        if (item instanceof Term) {
